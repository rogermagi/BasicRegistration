...
<form name="employee-form" action="emp-servlet" method="POST">
  ...
  <table class="tg">
    ...
    <tr>
      ...
      <td class="tg-0pky"><input type="text" name="empid" value=<%=employee.get("empID")%> disabled/></td>
      <td class="tg-0pky"><input type="text" name="newempid" id="newempid" value="<%=employee.get("empID")%>" readonly/></td>
